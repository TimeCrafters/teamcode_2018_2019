...
public class scott_state_auto30_align_with_vuforia extends State {
    public scott_state_auto30_align_with_vuforia(Engine engine, scott_state_hardware_config cHardwareConfig){
        this.engine = engine;
