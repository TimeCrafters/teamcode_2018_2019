...
public class CRDriveToCrater extends State {
    private String StepID = "CRDriveToCrater";
    ...
    public CRDriveToCrater(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
