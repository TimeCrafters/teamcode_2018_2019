...
public class Step12DLMineralStrait extends State {
    ...
    public Step12DLMineralStrait(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
