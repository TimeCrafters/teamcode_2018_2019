...
public class Step11DLReturnArc extends State {
    ...
    public Step11DLReturnArc(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
