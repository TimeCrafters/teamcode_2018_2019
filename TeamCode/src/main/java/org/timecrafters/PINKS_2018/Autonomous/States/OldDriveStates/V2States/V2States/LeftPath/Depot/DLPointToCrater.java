...
public class DLPointToCrater extends State {
    private String StepID = "DLPointToCrater";
    ...
    public DLPointToCrater(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
