...
public class DRPointToCrater extends State {
    private String StepID = "DRPointToCrater";
    ...
    public DRPointToCrater(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
