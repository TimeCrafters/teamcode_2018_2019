...
public class DCDriveToCrater extends State {
    private String StepID = "DCDriveToCrater";
    ...
    public DCDriveToCrater(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
