...
public class Step10CRReturnArc extends State {
    private String StepID = "CRReturnArc";
    public StateConfiguration AppReader;
    public PinksHardwareConfig PinksHardwareConfig;



    public Step10CRReturnArc(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
