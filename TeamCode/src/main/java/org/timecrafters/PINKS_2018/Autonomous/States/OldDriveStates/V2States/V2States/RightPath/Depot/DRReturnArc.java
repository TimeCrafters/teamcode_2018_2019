...
public class DRReturnArc extends State {
    private String StepID = "DRReturnArc";
    ...
    public DRReturnArc(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
