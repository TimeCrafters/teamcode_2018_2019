...
public class Step10DCDriveToDepot extends State {
    ...
    public Step10DCDriveToDepot(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
