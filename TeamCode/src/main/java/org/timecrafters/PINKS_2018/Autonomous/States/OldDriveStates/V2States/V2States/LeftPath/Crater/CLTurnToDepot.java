...
public class CLTurnToDepot extends State {
    private String StepID = "CLTurnToDepot";
    ...
    public CLTurnToDepot(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
