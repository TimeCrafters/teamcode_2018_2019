...
public class CCDriveToDepot extends State {
    private String StepID = "CCDriveToDepot";
    ...
    public CCDriveToDepot(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
