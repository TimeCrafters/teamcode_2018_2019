...
public class CLReturnReverse extends State {
    private String StepID = "CLReturnReverse";
    ...
    public CLReturnReverse(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
