...
public class CLDriveToDepot extends State {
    private String StepID = "CLDriveToDepot";
    ...
    public CLDriveToDepot(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
