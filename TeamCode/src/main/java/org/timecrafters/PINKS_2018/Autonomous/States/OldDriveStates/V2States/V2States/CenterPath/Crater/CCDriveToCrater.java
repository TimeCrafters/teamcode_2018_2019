package org.timecrafters.PINKS_2018.Autonomous.States.OldDriveStates.V2States.V2States.CenterPath.Crater;
...
public class CCDriveToCrater extends State {
    private String StepID = "CCDriveToCrater";
    ...
    public CCDriveToCrater(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
