...
public class CRDriveToDepot extends State {
    private String StepID = "CRDriveToDepot";
    ...
    public CRDriveToDepot(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
