...
public class CRReturnReverse extends State {
    private String StepID = "CRReturnReverse";
    ...
    public CRReturnReverse(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
