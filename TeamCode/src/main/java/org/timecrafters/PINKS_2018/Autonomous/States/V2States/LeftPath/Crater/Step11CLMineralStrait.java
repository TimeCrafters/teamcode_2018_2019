package org.timecrafters.PINKS_2018.Autonomous.States.V2States.LeftPath.Crater;
...
public class Step11CLMineralStrait extends State {
    ...
    public Step11CLMineralStrait(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
