...
public class DCPointToGold extends State {
    private String StepID = "DCPointToGold";
    ...
    public DCPointToGold(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
