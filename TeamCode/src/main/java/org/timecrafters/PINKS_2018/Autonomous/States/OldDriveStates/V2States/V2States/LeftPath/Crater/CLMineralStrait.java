package org.timecrafters.PINKS_2018.Autonomous.States.OldDriveStates.V2States.V2States.LeftPath.Crater;
...
public class CLMineralStrait extends State {
    private String StepID = "CLMineralStrait";
    ...
    public CLMineralStrait(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
