...
public class DRMineralStrait extends State {
    private String StepID = "DRMineralStrait";
    ...
    public DRMineralStrait(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
