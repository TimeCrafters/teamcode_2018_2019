...
public class CCReturnReverse extends State {
    private String StepID = "CCReturnReverse";
    ...
    public CCReturnReverse(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
