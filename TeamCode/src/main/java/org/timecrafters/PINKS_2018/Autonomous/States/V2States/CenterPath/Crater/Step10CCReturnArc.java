...
public class Step10CCReturnArc extends State {
    ...
    public Step10CCReturnArc(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
