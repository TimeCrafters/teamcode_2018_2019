...
public class CLDriveToCrater extends State {
    private String StepID = "CLDriveToCrater";
    ...
    public CLDriveToCrater(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
