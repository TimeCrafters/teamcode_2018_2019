...
public class CLDriveToGold extends State {
    private String StepID = "CLDriveToGold";
    ...
    public CLDriveToGold(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
