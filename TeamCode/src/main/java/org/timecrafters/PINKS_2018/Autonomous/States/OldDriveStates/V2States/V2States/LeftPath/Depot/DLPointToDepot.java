...
public class DLPointToDepot extends State {
    private String StepID = "DLPointToDepot";
    ...
    public DLPointToDepot(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
