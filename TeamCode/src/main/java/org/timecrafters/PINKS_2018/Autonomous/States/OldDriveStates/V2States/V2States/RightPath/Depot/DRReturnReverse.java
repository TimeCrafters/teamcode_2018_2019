...
public class DRReturnReverse extends State {
    private String StepID = "DRReturnReverse";
    ...
    public DRReturnReverse(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
