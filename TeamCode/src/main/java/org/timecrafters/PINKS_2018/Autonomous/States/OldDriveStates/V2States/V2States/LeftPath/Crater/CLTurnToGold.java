...
public class CLTurnToGold extends State {
    private String StepID = "CLTurnToGold";
    ...
    public CLTurnToGold(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
