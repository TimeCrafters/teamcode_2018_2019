package org.timecrafters.PINKS_2018.Autonomous.States.OldDriveStates.V2States.V2States.RightPath.Depot;
...
public class DRDriveToCrater extends State {
    private String StepID = "DRDriveToCrater";
    ...
    public DRDriveToCrater(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
