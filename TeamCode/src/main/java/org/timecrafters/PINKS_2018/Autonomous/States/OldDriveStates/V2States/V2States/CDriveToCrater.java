package org.timecrafters.PINKS_2018.Autonomous.States.OldDriveStates.V2States.V2States;
...
public class CDriveToCrater extends State {
    private String StepID = "CDriveToCrater";
    ...
    public CDriveToCrater(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
