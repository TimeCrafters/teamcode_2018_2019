...
public class CRPointToGold extends State {
    private String StepID = "CRPointToGold";
    ...
    public CRPointToGold(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
