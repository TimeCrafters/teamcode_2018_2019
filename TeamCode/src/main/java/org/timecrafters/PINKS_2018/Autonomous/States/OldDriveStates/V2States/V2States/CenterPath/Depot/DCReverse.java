...
public class DCReverse extends State {
    private String StepID = "DCReverse";
    ...
    public DCReverse(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
