package org.timecrafters.PINKS_2018.Autonomous.States.V2States.RightPath.Depot;
...
public class Step09DRMineralBump extends State {
    ...
    public Step09DRMineralBump(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
