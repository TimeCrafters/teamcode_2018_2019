...
public class DLPointToGold extends State {
    private String StepID = "DLPointToGold";
    ...
    public DLPointToGold(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
