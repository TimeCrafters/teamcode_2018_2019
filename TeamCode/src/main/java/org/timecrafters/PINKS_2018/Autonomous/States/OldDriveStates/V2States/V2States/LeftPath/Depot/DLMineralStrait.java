package org.timecrafters.PINKS_2018.Autonomous.States.OldDriveStates.V2States.V2States.LeftPath.Depot;
...
public class DLMineralStrait extends State {
    private String StepID = "DLMineralStrait";
    ...
    public DLMineralStrait(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
