...
public class CLMineralBump extends State {
    private String StepID = "CLMineralBump";
    ...
    public CLMineralBump(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
