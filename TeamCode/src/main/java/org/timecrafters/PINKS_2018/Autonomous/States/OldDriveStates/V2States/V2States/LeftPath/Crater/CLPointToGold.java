...
public class CLPointToGold extends State {
    private String StepID = "CLPointToGold";
    ...
    public CLPointToGold(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
