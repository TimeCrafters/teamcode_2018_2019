...
public class DLReturnArc extends State {
    private String StepID = "DLReturnArc";
    ...
    public DLReturnArc(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
