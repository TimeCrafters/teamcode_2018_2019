...
public class CLReturnArc extends State {
    private String StepID = "CLReturnArc";
    ...
    public CLReturnArc(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
