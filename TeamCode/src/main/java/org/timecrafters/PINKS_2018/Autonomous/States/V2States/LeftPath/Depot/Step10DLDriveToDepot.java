...
public class Step10DLDriveToDepot extends State {
    ...
    public Step10DLDriveToDepot(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
