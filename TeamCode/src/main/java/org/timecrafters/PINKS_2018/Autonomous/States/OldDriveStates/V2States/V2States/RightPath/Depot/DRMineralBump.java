...
public class DRMineralBump extends State {
    private String StepID = "DRMineralBump";
    ...
    public DRMineralBump(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
