...
public class CTurnToDepot extends State {
    private String StepID = "CTurnToDepot";
    ...
    public CTurnToDepot(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
