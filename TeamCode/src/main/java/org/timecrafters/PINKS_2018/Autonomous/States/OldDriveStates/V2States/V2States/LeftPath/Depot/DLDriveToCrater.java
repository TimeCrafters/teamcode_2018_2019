...
public class DLDriveToCrater extends State {
    private String StepID = "DLDriveToCrater";
    ...
    public DLDriveToCrater(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
