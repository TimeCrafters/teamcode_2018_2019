...
public class CRTurnToDepot extends State {
    private String StepID = "CRTurnToDepot";
    ...
    public CRTurnToDepot(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
