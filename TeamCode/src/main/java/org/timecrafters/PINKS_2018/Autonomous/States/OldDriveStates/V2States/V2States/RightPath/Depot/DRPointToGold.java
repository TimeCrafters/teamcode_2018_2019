...
public class DRPointToGold extends State {
    private String StepID = "DRPointToGold";
    ...
    public DRPointToGold(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
