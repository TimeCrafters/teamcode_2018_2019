...
public class Step11CRMineralStrait extends State {
    private String StepID = "CRMineralStrait";
    ...
    public Step11CRMineralStrait(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
