...
public class Step10CLReturnArc extends State {
    ...
    public Step10CLReturnArc(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
