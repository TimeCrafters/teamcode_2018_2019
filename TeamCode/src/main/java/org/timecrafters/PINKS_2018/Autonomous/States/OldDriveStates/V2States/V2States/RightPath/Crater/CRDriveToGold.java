...
public class CRDriveToGold extends State {
    private String StepID = "CRDriveToGold";
    ...
    public CRDriveToGold(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
