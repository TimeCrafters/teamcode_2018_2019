...
public class DRDriveToDepot extends State {
    private String StepID = "DRDriveToDepot";
    ...
    public DRDriveToDepot(Engine engine, StateConfiguration appReader, PinksHardwareConfig pinksHardwareConfig) {
        this.engine = engine;
