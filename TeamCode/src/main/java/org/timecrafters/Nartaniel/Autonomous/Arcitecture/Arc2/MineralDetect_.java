...
public class MineralDetect_ extends SubEngine {
    Engine engine;
    public ArchitectureControl Control;

    public MineralDetect_(Engine engine, ArchitectureControl control) {
        this.engine = engine;
        Control = control;
    }
    ...
    public void setProcesses() {
        ...
        addState(new CompleteStepIndicator_(engine, "Mineral Detect", 1));
    }
